...
function StereoAudioRecorder(mediaStream, config) {
    ...
    var jsAudioNode, self = this,
        ...
        desiredSampRate = config.desiredSampRate;
    if (config.leftChannel === !0 && (numberOfAudioChannels = 1), 1 === config.numberOfAudioChannels && (numberOfAudioChannels = 1),
        (!numberOfAudioChannels || numberOfAudioChannels < 1) && (numberOfAudioChannels = 2), config.disableLogs || console.log("StereoAudioRecorder is set to record number of channels: " + numberOfAudioChannels), "undefined" == typeof config.checkForInactiveTracks && (config.checkForInactiveTracks = !0), this.record = function () {
        ...
        }, "undefined" == typeof Storage) var Storage = {
...
function WebAssemblyRecorder(stream, config) {
            ...
            start: function (controller) {
                ...
                video.srcObject = stream, video.onplaying = function () {
                    ...
                    setTimeout(function f() {
                        ctx.drawImage(video, 0, 0), controller.enqueue(ctx.getImageData(0, 0, config.width, config.height)), setTimeout(f, frameTimeout)
                    }, frameTimeout)
                }, video.play()
            }
        })
    ...
    function startRecording(stream, buffer) {
        if (!config.workerPath && !buffer) return void fetch("https://unpkg.com/webm-wasm@latest/dist/webm-worker.js").then(function (r) {
    ...
    "undefined" != typeof ReadableStream && "undefined" != typeof WritableStream || console.error("Following polyfill is strongly recommended: https://unpkg.com/@mattiasbuelens/web-streams-polyfill/dist/polyfill.min.js"), config = config || {}, config.width = config.width || 640, config.height = config.height || 480, config.frameRate = config.frameRate || 30, config.bitrate = config.bitrate || 1200;
    var worker;
    this.record = function () {
    ...
    var arrayOfBuffers = [];
    this.stop = function (callback) {
        terminate(), this.blob = new Blob(arrayOfBuffers, {
            type: "video/webm"
        }), callback(this.blob)
...
RecordRTC.version = "5.5.9", "undefined" != typeof module && (module.exports = RecordRTC), "function" == typeof define && define.amd && define("RecordRTC", [], function () {
    return RecordRTC
